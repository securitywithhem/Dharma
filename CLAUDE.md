...
You (Claude Code) are the orchestrator. Pick the specific tool for the job; don't invoke agents/skills reflexively for every task.
...
- `claude-code-guide` — questions about Claude Code/Agent SDK/API itself.
