...
export const CVSS_BANDS = {
  critical: {
    ...
    max: 10.0,
    label: 'Critical',
    color: 'text-dharma-danger-text',
    bgColor: 'bg-dharma-danger-bg',
  ...
  medium: {
    ...
    max: 6.9,
    label: 'Medium',
    color: 'text-dharma-ink',
    bgColor: 'bg-dharma-warning-bg',
  ...
  low: {
    ...
    max: 3.9,
    label: 'Low',
    color: 'text-dharma-success-text',
    bgColor: 'bg-dharma-success-bg',
